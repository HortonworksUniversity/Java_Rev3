...
public class StockDividendFilter extends Configured implements Tool {
  ...
  public static class StockFilterMapper extends Mapper<LongWritable, Text, Tuple, DoubleWritable> {
  ...
  public static class DividendMapper extends Mapper<LongWritable, Text, Tuple, DoubleWritable> {
    private String stockSymbol;
    private DoubleWritable outputValue = new DoubleWritable();
    Tuple outputKey = new Tuple();
